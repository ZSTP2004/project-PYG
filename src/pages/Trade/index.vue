<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(addressInfo, index) in address" :key="index">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="(order, index) in orderinfo.detailArrayList" :key="index">
          <li >
            <img :src="order.imgUrl" style="height:100px; width:100px" alt="">
          </li>
          <li>
            <p>
              {{ order.skuName }}</p>
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        let data = {
          ...
          consigneeTel: this.userDefaultAddress.phoneNum, //收件人的号码
          deliveryAddress: this.userDefaultAddress.fullAddress,//收件人地址
          paymentWat:"ONLINE",  //支付方式
