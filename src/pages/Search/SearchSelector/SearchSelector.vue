<template>
  <div class="clearfix selector">
    ...
    <div class="type-wrap" v-for="(attrs, index) in attrsList" :key="attrs.attrId">
      ...
      <div class="fl value">
        <ul class="type-list" v-for="(attrsValue, index) in attrs.attrValueList" :key="index" @click="attrInfo(attrs,attrsValue)">
          <li>
            <a>{{ attrsValue }}</a>
          </li>
        </ul>
  ...
  export default {
    ...
    methods:{
      tradeMarkHandler(trademark){
        // 因为 父组件 searchParams 是带给服务器参数 需要给父组件传递过去  （子传父 自定义事件）
